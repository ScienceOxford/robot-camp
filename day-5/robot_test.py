...
while True:
    drive(500,500)    # drives forwards (both motors at same speed)
    sleep(1000)       # keeps driving forwards for 1 second - change this number for longer or shorter!
    drive(-500,500)   # turns left (left motor backwards, right motor forwards)
    sleep(1000)
    drive(-500,-500)  # drives backwards (both motors at same speed, but minus)
    sleep(1000)
    drive(500,-500)   # turns right (left motor forwards, right motor backwards)
    sleep(1000)
    stop()
